    ...
    <Box sx={{ flexGrow: 1, display:"flex", justifyContent:"center", backgroundColor:"rgb(40, 40, 40)" }}>
      <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }} >
        ...
        <Grid item xs={8} sm={4} md={3} sx={{ display:"flex", justifyContent:"center" }}>
               <StoriesCard img={"https://cdn.pixabay.com/photo/2013/04/13/18/42/tower-103417_640.jpg"} />
        </Grid>
        <Grid item xs={8} sm={4} md={3} sx={{ display:"flex", justifyContent:"center" }}>
                <StoriesCard img={"https://cdn.pixabay.com/photo/2013/06/23/15/54/architecture-140785_640.jpg"} />
        </Grid>
        <Grid item xs={8} sm={4} md={3} sx={{ display:"flex", justifyContent:"center" }}>
                <StoriesCard img={"https://cdn.pixabay.com/photo/2014/11/30/14/11/cat-551554_640.jpg"} />
        </Grid>
        <Grid item xs={8} sm={4} md={3} sx={{ display:"flex", justifyContent:"center" }}>
                <StoriesCard img={"https://cdn.pixabay.com/photo/2021/07/25/12/22/tourist-attraction-6491734_640.jpg"} />
        </Grid>
        <Grid item xs={8} sm={4} md={3} sx={{ display:"flex", justifyContent:"center" }}>
                <StoriesCard img={"https://cdn.pixabay.com/photo/2021/07/25/12/22/tourist-attraction-6491734_640.jpg"} />
        </Grid>
